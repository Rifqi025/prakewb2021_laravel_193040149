...
<div class="container">
    <div class="row my-3">
       <div class="col-lg-10">
          ...
          <a href="/dashboard/posts/{{ $post->slug }}/edit" class="btn btn-warning mb-3"><span data-feather="edit"></span>
          Edit</a>
          <form actton="/dashboard/posts/{{ $post->slug }}" method="post" Class="d-inline">
          @method( 'delete')
          @csrf
